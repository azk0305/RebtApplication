...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSSortDescriptor *sortDescriptor = [[[NSSortDescriptor alloc] initWithKey:@"regDate" ascending:NO] autorelease];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[object valueForKey:@"aCell"] description];
    
    NSDateFormatter *regDateFormatter = [[[NSDateFormatter alloc] init] autorelease];
    regDateFormatter.dateFormat = @"記録日：yyyy年MM月dd日 HH時mm分ss秒";
    cell.detailTextLabel.text = [regDateFormatter stringFromDate:[object valueForKey:@"regDate"]];
}
